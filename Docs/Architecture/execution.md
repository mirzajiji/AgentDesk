...
Status: persisted run lifecycle, live/replay events and typed stage/step progress are implemented in P1-07a/b. An internal read-only Codex provider is implemented in P1-09b; P1-10 adds the internal policy/approval gate; P1-06b2 adds frozen environment/configuration/policy previews and validated output contracts. P1-12a/b/c implement scoped redaction, evidence storage and Git capture; execution/recovery coordination remains subsequent work. See [lifecycle validation](../Development/p1-07a-validation.md) and [progress validation](../Development/p1-07b-validation.md). Source: [final architecture](final-architecture.txt), sections 66–67.
