...
| P1-13b | Native execution setup service, environment/policy defaults and effective-context preparation | Preserved existing settings, explicit defaults, revision conflicts, scope and preview tests |
