...
| P3-05 | In progress: native plugin setup and diagnostics | Enable/configure/login/save/test/disconnect/logout/reset, permission review, real account/scope/status/health, compact windows and native lifecycle tests. Configuration browsing/editing and native sign-in integration components: [validation](p3-05-validation.md). Live registration and full lifecycle acceptance remain open. |
