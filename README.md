...
The persistent Bug Registry retains reviewed defect versions, manual ticket associations, exact references and scoped relationships. Duplicate-review services compare current behavior and requirements, prepare policy-bound Codex ambiguity reviews, retain explicit local decisions, and draft sanitized evidence for known tickets. Native bug management remains P2-10; external tickets are not sent. See [registry validation](Docs/Development/p2-07-validation.md) and [duplicate-review validation](Docs/Development/p2-08-validation.md).
